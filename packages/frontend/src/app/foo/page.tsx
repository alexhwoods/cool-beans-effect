      ...
      <div className="max-w-4xl mx-auto">
          ...
          <Link href="/foo/server-component">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10 cursor-pointer group">
              ...
              <p className="text-gray-400 mb-4">
                ...
                to fetch all data on the server before rendering.
              </p>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <svg
                  className="w-4 h-4"
        ...
        <div className="mt-8 bg-purple-500/10 border border-purple-500/30 rounded-xl p-6">
          ...
          <ul className="text-gray-400 text-sm mt-2 space-y-1 ml-4">
            <li>
              • <strong>Client Component:</strong> Streams directly from browser
              to backend
            </li>
            <li>
              • <strong>Server Collect:</strong> Server waits for all data
              before rendering
            </li>
            <li>
              • <strong>Server Streaming:</strong> Server streams via API route
