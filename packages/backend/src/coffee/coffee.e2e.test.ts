...
// Client service that can be injected into tests
...
beforeAll(async () => {
  ...
  // Create layer by directly providing the protocol to the scoped effect
  ClientLive = Layer.scoped(
    RpcClientLive,
...
describe("Coffee RPC E2E", () => {
  ...
  //       Effect.gen(function* () {
  //         // Arrange
  //         const client = yield* TestRpcClient;
